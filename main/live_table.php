  ...
  $servername = "localhost";
    ...
    die("Connection failed: " . $conn->connect_error);
     ...
     $result = mysqli_query($conn, "SELECT * from live_".$now." order by measure_date desc limit 5");
      echo "<div class = 'vs'>";  
	...
	echo "<table class='type01'>
     <th>기기번호 </th><th>측정시간 </th><th>데이터 코드 </th><th>데이터 이름 </th><th>측정 값 </th><th>데이터 단위</th>
